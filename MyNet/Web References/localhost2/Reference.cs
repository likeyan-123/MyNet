...
namespace MyNet.localhost2 {
    ...
    public partial class WebService1 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public System.Data.DataSet update(string infor1, string infor2) {
        ...
        /// <remarks/>
        public void updateAsync(string infor1, string infor2) {
            this.updateAsync(infor1, infor2, null);
        }
        
        /// <remarks/>
        public void updateAsync(string infor1, string infor2, object userState) {
            if ((this.updateOperationCompleted == null)) {
                this.updateOperationCompleted = new System.Threading.SendOrPostCallback(this.OnupdateOperationCompleted);
            }
            this.InvokeAsync("update", new object[] {
                        infor1,
                        infor2}, this.updateOperationCompleted, userState);
        }
